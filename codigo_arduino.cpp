...
//Armazenam os pinos correspondentes aos botões de cada cabine e dos corredores.
...
// A função setup() inicializa os servomotores, configura os pinos de entrada e posiciona as cabines no térreo.
void setup() {
  Serial.begin(9600);
...
//Verifica se existe alguma solicitação pendente acima da posição atual da Cabine 1.
